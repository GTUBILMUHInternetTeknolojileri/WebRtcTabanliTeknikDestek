<%@ Page Title="" Language="C#" MasterPageFile="~/yonetici.Master" AutoEventWireup="true" CodeBehind="firma.aspx.cs" Inherits="TeknikOfis.firma" %>
<%@ MasterType VirtualPath="~/yonetici.Master" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Kurum İşlemleri (MACİK-Teknik Ofis)</title>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="form-horizontal" role="form">
        <div class="form-group">
            <label class="col-sm-3 control-label no-padding-right" for="form_field_1">Ad </label>
            <div class="col-sm-9">
                <asp:TextBox ID="form_field_1" runat="server" TabIndex="1" placeholder="Kurum adı" class="col-xs-10 col-sm-5"></asp:TextBox>
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-3 control-label no-padding-right" for="form_field_2">Adres </label>
            <div class="col-sm-9">
                <asp:TextBox ID="form_field_2" runat="server" TabIndex="2" TextMode="MultiLine" placeholder="Adres" class="col-xs-10 col-sm-5" MaxLength="256"></asp:TextBox>
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-3 control-label no-padding-right" for="form_field_3">İl </label>
            <div class="col-sm-9">
                <asp:TextBox ID="form_field_3" runat="server" TabIndex="3" placeholder="İl" class="col-xs-10 col-sm-5"></asp:TextBox>
            </div>
        </div>
        ...
        <div class="form-group">
            <label class="col-sm-3 control-label no-padding-right" for="form_field_5">Faks </label>
            <div class="col-sm-9">
                <div class="input-group">
                    <span class="input-group-addon">
                        <i class="ace-icon fa fa-phone"></i>
                    </span>
                    <asp:TextBox ID="form_field_5" runat="server" TabIndex="5" placeholder="Faks" class="col-xs-10 col-sm-3 input-mask-phone" TextMode="Phone"></asp:TextBox>
                    <span class="help-inline col-xs-12 col-sm-7">
                        <span class="middle">(999) 999-9999</span>
                    </span>
                </div>
        ...
        <div class="form-group">
            <label class="col-sm-3 control-label no-padding-right" for="form_field_6">E-posta </label>
            <div class="col-sm-9">
                <div class="input-group">
                    <span class="input-group-addon">
                        <i class="ace-icon fa fa-envelope"></i>
                    </span>
                    <asp:TextBox ID="form_field_6" runat="server" TabIndex="6" placeholder="e-posta" class="col-xs-10 col-sm-5 input-mask-email" TextMode="Email"></asp:TextBox>
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="Geçersiz e-posta formatı." ControlToValidate="form_field_6" ValidationExpression="^([\w\.\-]+)@([\w\-]+)((\.(\w){2,3})+)$" ForeColor="#CC0000"></asp:RegularExpressionValidator>
                </div>
            </div>
        </div>
            ...
            <div class="form-group">
                <div class="col-xs-12 col-sm-4 col-sm-offset-3">
                    <label>
                        ...
                        <span class="lbl">Kurum faaliyette değil.</span>
                    </label>
                </div>
            </div>
            <hr />
        ...
        <div class="form-group">
            <label class="col-sm-3 control-label no-padding-right" for="form_DropDownList_1">Kurum Türü </label>
            <div class="col-sm-9">
                <asp:DropDownList ID="form_DropDownList_1" runat="server" TabIndex="8"></asp:DropDownList>
            </div>
        </div>
        ...
        <div class="col-xs-12">
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" AllowPaging="True" OnSorting="GridView1_Sorting"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="ad" HeaderText="Kurum"
                        SortExpression="ad" HtmlEncode="False" ItemStyle-Width="38%"/>
                    <asp:BoundField DataField="adres" HeaderText="Adresi"
                        SortExpression="adres" HtmlEncode="False" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="25%"/>
                    <asp:BoundField DataField="il" HeaderText="İli"
                        SortExpression="il" HtmlEncode="False" HeaderStyle-HorizontalAlign="Center" />
                    ...
                    <asp:BoundField DataField="faks" HeaderText="Faks"
                        SortExpression="faks" HtmlEncode="False" HeaderStyle-HorizontalAlign="Center" />
                    <asp:BoundField DataField="eposta" HeaderText="E-posta"
                        SortExpression="eposta" HtmlEncode="False" HeaderStyle-HorizontalAlign="Center" />
                    <asp:TemplateField HeaderText="Türü" HeaderStyle-HorizontalAlign="Center" SortExpression="tur_id">
                        <ItemTemplate>
