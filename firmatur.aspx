<%@ Page Title="" Language="C#" MasterPageFile="~/yonetici.Master" AutoEventWireup="true" CodeBehind="firmatur.aspx.cs" Inherits="TeknikOfis.firmatur" %>
<%@ MasterType VirtualPath="~/yonetici.Master" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Kurum Türü İşlemleri (MACİK-Teknik Ofis)</title>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="form-horizontal" role="form">
        <div class="form-group">
            <label class="col-sm-3 control-label no-padding-right" for="form_field_1">Tür </label>
            <div class="col-sm-9">
                <asp:TextBox ID="form_field_1" runat="server" TabIndex="1" placeholder="Kurum türü" class="col-xs-10 col-sm-5"></asp:TextBox>
            </div>
        </div>
        ...
        <div class="col-xs-12">
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" AllowPaging="True" 
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="ad" HeaderText="Kurum Türü"
