<%@ Page Title="" Language="C#" MasterPageFile="~/yonetici.Master" AutoEventWireup="true" CodeBehind="ariza_tur.aspx.cs" Inherits="TeknikOfis.ariza_tur" %>
<%@ MasterType VirtualPath="~/yonetici.Master" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Arıza Türleri (MACİK-Teknik Ofis)</title>
    <meta name="description" content="Arıza tür işlemleri ekranı" />
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="form-horizontal" role="form">
        <div class="form-group">
            <label class="col-sm-3 control-label no-padding-right" for="form_field_1">Arıza Türü </label>
            <div class="col-sm-9">
                <asp:TextBox ID="form_field_1" runat="server" TabIndex="1" placeholder="Arıza türü" class="col-xs-10 col-sm-5" MaxLength="150"></asp:TextBox>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-xs-12">
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" AllowPaging="True" 
                AllowSorting="True" TabIndex="13" class="col-md-offset-2 col-sm-5" PageSize="20" OnSorting="GridView1_Sorting"
                OnRowCommand="ContactsGridView_RowCommand" OnPageIndexChanging="GridView_PageIndexChanging"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="ad" HeaderText="Arıza Türü"
