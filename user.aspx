<%@ Page Title="" Language="C#" MasterPageFile="~/user.Master" AutoEventWireup="true" CodeBehind="user.aspx.cs" Inherits="TeknikOfis.user1" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajaxToolkit" %>
<%@ MasterType VirtualPath="~/user.Master" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Arıza bildirimlerini yönetme sayfası (MACİK-Teknik Ofis)</title>
    <meta name="description" content="Kullanıcının, açmış olduğu arıza bildirimlerini yönetme sayfası" />
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <Columns>
                ...
                <asp:TemplateField ShowHeader="False">
                    <ItemTemplate>
                        ...
                        <asp:LinkButton ID="btnEdit" runat="server" Text="" class="ace-icon fa fa-pencil center bigger-110 blue"
    ...
    <asp:Panel runat="server" CssClass="modalPopup" ID="PopupDuzelt" Width="500">
        <div class="page-content">
            ...
            <div class="message-body">
                <div class="row">
                    <!--<asp:UpdatePanel ID="odalar2" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="True" Style="cursor: move; background-color: #DDDDDD; border: solid 1px Gray; color: Black">
                        <ContentTemplate> -->
                            <div class="form-horizontal" role="form">
                                ...
                                <div class="row">
                                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1">İlgili (*)</label>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="kisi" runat="server" TabIndex="1" placeholder="Ad Soyad" MaxLength="50" class="col-xs-12 col-sm-12"></asp:TextBox>
                                    </div>
                                </div>

                                <div class="row">
                                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1-1">Tel (*)</label>
                                    <div class="col-sm-9">
                                        <span class="input-icon">
                                            <asp:TextBox ID="phone" runat="server" TabIndex="2" placeholder="Tel" class="input-mask-phone" TextMode="Phone" MaxLength="14"></asp:TextBox>
                                ...
                                <div class="row">
                                    <label class="col-sm-3 control-label no-padding-right" for="form-field-2">Dahili </label>

                                    <div class="col-xs-12 col-sm-9">
                                        <asp:TextBox ID="dahili" runat="server" TabIndex="3" placeholder="Dahili" class="input-mask-dahili col-sm-4" TextMode="Phone" MaxLength="10"></asp:TextBox>
                                    </div>
                                </div>

                                <div class="row">
                                    <label class="col-sm-3 control-label no-padding-right" for="form-input-readonly">Faks </label>

                                    <div class="col-sm-9">
                                        <span class="input-icon">
                                            <asp:TextBox ID="faks" runat="server" TabIndex="4" placeholder="Faks" class="input-mask-phone" TextMode="Phone" MaxLength="14"></asp:TextBox>
                                            <i class="ace-icon fa fa-phone blue"></i>
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <label class="control-label col-xs-12 col-sm-3 no-padding-right" for="form_DropDownList_1">Arıza Türleri (*)</label>
                                    <div class="col-sm-8">
                                        <asp:DropDownList ID="form_DropDownList_1" runat="server" TabIndex="5" class="col-xs-12 col-sm-9"></asp:DropDownList>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="marka" runat="server" TabIndex="6" placeholder="Markası" MaxLength="50" class="col-xs-12 col-sm-12"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="row">
                                    <label class="col-sm-3 control-label no-padding-right" for="form_field_1">Model (*)</label>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="model" runat="server" TabIndex="7" placeholder="Modeli" MaxLength="50" class="col-xs-12 col-sm-12"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="row">
                                    <label class="col-sm-3 control-label no-padding-right" for="form_field_1">Seri No </label>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="seri_no" runat="server" TabIndex="8" placeholder="Seri Numarası" MaxLength="50" class="col-xs-12 col-sm-12"></asp:TextBox>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <label class="control-label col-xs-12 col-sm-3 no-padding-right" for="comment">Açıklama (*)</label>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="comment" runat="server" TabIndex="9" TextMode="MultiLine" class="col-xs-12 col-sm-12"></asp:TextBox>
                                    </div>
                                </div>
                                <label class="col-sm-12 no-padding align-center red">Lütfen (*) olan alanları boş bırakmayınız.</label>
                                <div class="clearfix form-actions">
                                    <div class="col-md-offset-3 col-md-9">
                                        <asp:LinkButton runat="server" ID="LinkButton6" Text="<i class='ace-icon fa fa-pencil-square-o'></i> Düzelt"
                                            OnClick="poupDuzeltim" class="btn btn-sm btn-danger" data-dismiss="modal" TabIndex="10" />
